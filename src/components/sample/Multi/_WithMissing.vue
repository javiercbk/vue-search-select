  ...
  export default {
    data () {
      return {
        ...
        items: [
          { value: 'missing1', text: 'missing1', missing: true },
          { value: 'missing2', text: 'missing2', missing: true }
        ],
        lastSelectItem: {}
      }
    },
...
<style>
.item[data-vss-custom-attr="missing"] {
  color: red !important;
}
.ui.label[data-vss-custom-attr="missing"] {
  color: blue;
}
.ui.label[data-vss-custom-attr="missing"]:hover {
